    ...
    <div className="flex flex-col items-center gap-2 pt-4 border-t border-gray-100">
      ...
      <div className="relative flex items-center justify-center select-none">
        ...
        >
          ...
          <path
            id="arcBottom"
            d="M 20,65 A 42,42 0 0,0 100,65"
            fill="none"
          />
          ...
          {/* Ícono central: escudo con check */}
          <path
            d="M60 34 L74 40 L74 55 C74 63 68 69 60 72 C52 69 46 63 46 55 L46 40 Z"
            fill="#E8B84B"
          />
          <path
            d="M54 54 L58 58 L67 48"
            stroke="#002070"
            strokeWidth="3"
            strokeLinecap="round"
        ...
        <div className="flex flex-col items-center gap-3 text-center">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Estás a punto de solicitar el sello de la academia para este recurso educativo. Esta acción quedará registrada con tu nombre.
            </p>
          </div>
        </div>
...
export default function BadgeSello({
  ...
  const botonEstilos = {
    sin_sello: 'bg-gray-900 text-white border-gray-700 hover:opacity-90 hover:shadow-md cursor-pointer',
    pendiente: 'bg-amber-50 text-amber-800 border-amber-300 cursor-default',
    aprobado:  'bg-emerald-50 text-emerald-800 border-emerald-300 cursor-default',
    rechazado: 'bg-red-50 text-red-700 border-red-300 cursor-default',
  }

  const botonLabels = {
    sin_sello: 'Añadir sello de academia',
    pendiente: 'Sello en revisión',
    aprobado:  'Sello otorgado',
    rechazado: 'Sello rechazado',
  }
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-4">
        ...
        <button
          type="button"
          onClick={() => puedeInteractuar && setModalAbierto(true)}
        ...
        {/* Sello visual — solo cuando está aprobado */}
        {estado === 'aprobado' && (
